      ...
      <div className=" max-w-7xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="w-full grid md:grid-cols-2 grid-cols-1 gap-6 lg:px-22">
          ...
          <div className="w-full h-full flex flex-col gap-6">
            ...
            <div className="px-4 py-8 rounded-lg shadow-xs hover:shadow-sm border flex flex-col items-center border border-creme-white duration-300 h-full">
          ...
          <div className="w-full h-full flex flex-col gap-6">
            ...
            <div className="px-4 py-8 h-full rounded-lg shadow-xs hover-shadow-sm border flex flex-col items-center border border-creme-white duration-300 h-full">
