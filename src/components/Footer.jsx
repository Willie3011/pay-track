            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="w-full flex flex-col max-sm:justify-center max-sm:items-center">
                        ...
                        <button className="w-min whitespace-nowrap flex items-center gap-2 border border-accent rounded-lg text-accent hover:text-primary hover:bg-accent p-4 uppercase text-sm cursor-pointer duration-300"><IoIosArrowUp /> Back to top</button>
                    </div>
                    <div className="w-full flex flex-col max-sm:justify-center max-sm:items-center">
